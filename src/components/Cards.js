    ...
    componentDidMount(){
        ...
        .then(result=>{
            ...
            this.setState({
                ...
                diffConfirmed:Number(result.cases_time_series[result.cases_time_series.length-1].totalconfirmed) -  Number(result.cases_time_series[result.cases_time_series.length-2].totalconfirmed)
            },()=>{
            ...
            <div>
                <Container className="cards-container">
                    <Row>
                        ...
                        <Col md="3">
                            <AppCard heading="Active" fontColor="#037AFB" backgroundColor="rgba(0,123,255,.0627451)" cases = {this.state.active}/>
                        </Col>
                        <Col md="3">
                            <AppCard heading="Recovered" fontColor="#50A745" backgroundColor="rgba(40,167,69,.12549)" cases = {this.state.recovered}/>
                        </Col>
                        <Col md="3">
                            <AppCard heading="Deceased" fontColor="gray" backgroundColor="rgba(108,117,125,.0627451)" cases = {this.state.deaths}/>
                        </Col>
                    </Row>
                </Container>
